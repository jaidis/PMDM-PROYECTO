...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager
                .beginTransaction()
                .replace(R.id.content_main, FragmentLogin.newInstance("Nothing to do here"), "rageComicList")
                .commit()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_maps -> {
                supportFragmentManager
                        .beginTransaction()
                        .replace(R.id.content_main, FragmentMaps.newInstance("Nothing to do here"), "rageComicList")
                        .commit()
            }
            /*R.id.nav_manage -> {
